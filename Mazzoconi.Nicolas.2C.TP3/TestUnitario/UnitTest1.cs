...
namespace TestUnitario
{
	...
	public class UnitTest1
	{
		...
		public void TestExceptionDniInvalido()
		{
			try
			{
				Alumno a1 = new Alumno(1, "Pedro", "Lopez", "sssdds455", EntidadesAbstractas.Persona.ENacionalidad.Argentino, Universidad.EClases.SPD, Alumno.EEstadoCuenta.AlDia);
			}
			catch (Exception ex)
			{
		...
		public void TestDniValidoParaNacionalidad()
		{
			try
			{
				Alumno a1 = new Alumno(1, "Pedro", "Lopez", "91000000", EntidadesAbstractas.Persona.ENacionalidad.Argentino, Universidad.EClases.SPD, Alumno.EEstadoCuenta.AlDia);
			}
			catch(Exception ex)
			{
		...
		public void TestAtributosNull()
		{
			...
			if (uni.Alumnos is null || uni.Jornadas is null || uni.Profesores is null)
				Assert.IsTrue(false);
			Assert.IsTrue(true);
		}
